...
public class CrazyGenerics {
    ...
    static class CollectionUtil {
         ...
         */
        public static boolean isValidCollection(Collection<? extends BaseEntity> entities, Predicate<? super BaseEntity> predicate) {
            return entities.stream()
                    .allMatch(predicate);
        }
        ...
        public static <T extends BaseEntity> boolean hasDuplicates(Collection<T> entities, T targetEntity) {
            return entities.stream()
                    .filter(el -> el.getUuid().equals(targetEntity.getUuid()))
                    .count() > 1;
        }
